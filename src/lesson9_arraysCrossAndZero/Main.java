package lesson9_arraysCrossAndZero;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            int row = Integer.parseInt(parts[0]) - 1; // 2-1 = 1
            int col = Integer.parseInt(parts[1]) - 1; // 3-1 = 2

            if (field[row][col] != EMPTY) {
                System.out.println("Сюда ходить нельзя!");
                continue;
            }
            field[row][col] = isCrossTurn ? CROSS : ZERO;
